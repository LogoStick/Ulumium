...
public class ChangePassResponseGenerator implements ResponseGenerator {
    ...
    public ResponseEntity<String> generateResponse(ResponseGeneratorArgument arguments) {
        ...
        if (successfulOperation) {
            ...
            return ResponseEntity
                    ...
                    .body(new JSONObject().put("SuccessfulPasswordChange", true).toString());
        } else {
            HttpHeaders responseHeaders = new HttpHeaders();
            responseHeaders.setContentType(MediaType.APPLICATION_JSON);
            return ResponseEntity
                    .ok()
                    .headers(responseHeaders)
                    .body(new JSONObject().put("SuccessfulPasswordChange", false).toString());
        }
    }
}
