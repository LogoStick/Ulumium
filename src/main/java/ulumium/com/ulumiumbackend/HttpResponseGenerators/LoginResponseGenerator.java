...
public class LoginResponseGenerator implements ResponseGenerator{
    ...
    public ResponseEntity<String> generateResponse(ResponseGeneratorArgument arguments) {
        ...
        if(successfulOperation) {
            ...
            responseHeaders.setAccessControlExposeHeaders(Lists.newArrayList("Authorization"));
            ...
            return ResponseEntity
                    ...
                    .body(new JSONObject().put("SuccessfulAuthentication", true).toString());
            ...
            return ResponseEntity
                    .ok()
                    .headers(responseHeaders)
                    .body(new JSONObject().put("SuccessfulAuthentication", false).toString());
        }
    }
}
